...
namespace UI
{
    public class UiTextLink : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public void OnPointerClick (PointerEventData eventData) {
            int linkIndex = TMP_TextUtilities.FindIntersectingLink(textMessage, eventData.position, null);
            if (linkIndex == -1)
                return;
