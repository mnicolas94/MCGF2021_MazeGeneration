...
{
    [CreateAssetMenu(fileName = "IntersectionDetector", menuName = "Maze/InterestPointDetectors/IntersectionDetector", order = 0)]
    public class IntersectionDetector : InterestPointDetector
    {
        public override List<Vector3Int> GetInterestingPoints(Maze maze)
        {
            ...
            foreach (var tilePosition in floorPositions)
            {
                ...
                bool isHall = neighbourValue > 2 && neighbourValue <= 4;
