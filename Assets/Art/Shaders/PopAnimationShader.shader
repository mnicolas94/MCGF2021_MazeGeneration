Shader "Unlit/PopAnimationShader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                fixed4 colOutside = SampleSpriteTexture (_MainTex, i.uv) * (1 - insideRadius);
                colOutside.rgb *= colOutside.a;
                fixed4 colInside = SampleSpriteTexture(_AlternativeTex, i.uv) * insideRadius;
